    ...
    return (
        <div className={`${ProfileNavbarStyles.profileNavbarContainer} mr-15`}>
            <nav className={`${ProfileNavbarStyles.profileNavbar}`}>
                ...
                <p data-testid={'profile-logout'} onClick={() => {dispatch(logout())}} className={`${ProfileNavbarStyles.navbarElem} pt-4 pb-4 text text_type_main-medium text_color_inactive`}>Выход</p>
            </nav>
